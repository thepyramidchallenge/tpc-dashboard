...
window.TPC_DASHBOARD = {
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "Source of truth for full-stack platform work. Consolidated release source is codex/reconcile-backend-live / PR #3; it contains the recovered production lineage plus latest main and matches the deployed backend hashes. After source closeout: build Natalie's zero-API local CLI question-generation lane, then choose independent generator/admission providers, replace the 51-write browser maximum with a worker or verified 429 continuation, migrate/read back staging tabs, and run backend-first smokes.",
    },
    {
      id:    "entrance-qr-scan",
