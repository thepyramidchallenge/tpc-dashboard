...
window.TPC_DASHBOARD = {
  ...
  focus:
    "Pilot readiness is bottlenecked by approved official K2/K3 content, measured human/device evidence and one focused fallback correction. Backend source 5552ba16 is live on tpc-api-fm5552ba16 at 100%; frontend source b38d43aa is live as Pages a50a18cf. PR #204's recovery UI is live, but WS6.1-13 is reopened until PR #209's non-destructive draft-preservation fix is merged and deployed. Run the real WS6.1-10/11/29 pilot and 10–20-device rehearsal before UAT, replace or unpublish the sole dummy mock, and treat repository enforcement as best-effort until a paid GitHub branch rule blocks direct/manual bypass.",
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "Current live boundary: frontend source b38d43aa is Pages a50a18cf through successful workflow 31168614500, serving index-Dp9Ew9mb.js and index-wWaS5Ztz.css; backend source 5552ba16 is tpc-api-fm5552ba16 at 100%, digest sha256:552224c7e9da6511a70950b27e1c44bb998f6e4075b3b95635837573b71b0d23, with PRACTICE_COMPARISON_ENABLED=true and max-instances=1. PR #204's bilingual recovery UI is live, but its invalid-question leave action can discard a draft; PR #209 is the focused non-destructive fix and WS6.1-13 remains open until that exact source is live. Other launch gates are approved official K2/K3 content, real WS6.1-10/11/29 human/device evidence, and replacement/unpublication of the sole dummy mock.",
    },
    {
  ...
  board: {
    now: [
      ...
      { title: "Pilot reliability evidence", project: "tpc-online-platform", owner: "natalie", note: "WS6.1-13/13a–13c are reopened: PR #204 shipped the fallback matrix and bilingual recovery UI, but an independent audit found the invalid-question leave action used the destructive draft-discard path. PR #209 separates recovery from discard and must merge/deploy before closure. WS6.1-10/10a–10d, WS6.1-11 and WS6.1-29 still require real controlled concurrency, a small-class pilot, and the 10–20-device one-hour rehearsal." },
    ...
    next: [
      ...
      { title: "WS6.1 - pilot-gating polish", project: "tpc-online-platform", owner: "natalie", note: "Do only launch-critical work before real users: merge/deploy PR #209's non-destructive fallback leave fix, then close WS6.1-13; pilot-scale concurrency/write-contention proof and accuracy consistency remain under WS6.1-11. WS6.1-15/15a's Mixed · Easy · 10 decision/review is closed; no unavailable learner result is claimed. Broader recommendation review/pilot remain WS8-03a/-03b, while the real small-class launch pilot remains WS6.1-11." },
  ...
  roadmap: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "WS6.1-13/13a–13c - Fallback matrix + bilingual recovery live; draft-preservation correction PR #209 pending", state: "active" },
