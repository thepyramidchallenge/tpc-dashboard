...
window.TPC_DASHBOARD = {
  ...
  focus:
    "WS5.1-18 family + WS5.1-19 CLOSED (all founder-smoked, incl. the 18g bell→editor click). Founder now owes: ratify the 詞彙批准表 vocabulary/taxonomy packet (18i+01c, review underway), decide WS5.2-01a seed-pack scope, and two live smokes (panel-parity on a real phone · whitelist grant/revoke bell). Engineering: WS5.2-02e approval-evaluation panel + backend are source-complete — migrate the QuestionReviewEvaluations tab → deploy → §10.2 smoke, then seed-pack lane → WS5.1-04 sets.",
  ...
  board: {
    now: [
      { title: "Founder actions — ratify 詞彙批准表 · panel-parity phone · whitelist bell", project: "tpc-online-platform", owner: "natalie", note: "① Ratify the 18i+01c vocabulary/taxonomy packet (docs/VOCABULARY_RATIFICATION.md, nine packet decisions; Appendix A reviewed, 取消自我批准 amendment recorded — apply nothing until ratified). ② Open the admin console on a real phone (100dvh pager behaviour; dashboard flip waits on it). ③ Grant/revoke self-approval → target admin's bell rings (tpc-api-00059-rwn). Also still owed when convenient: editor asset-picker path smoke (WS5.3-03)." },
