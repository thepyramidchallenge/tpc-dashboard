...
window.TPC_DASHBOARD = {
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "The 2026-08-07 Academy visual release is source-complete on private main bb9eba6: platform-wide cool/pure-white/accent-blue language, six credited curations, Field Atlas answer screen, Pico, the living-observatory 我的星空 camera stack, and the founder-supplied Academy lockup/name. All frontend/backend gates passed and public Pages artifact f5145db was pushed. Outage-stuck run 31127881957 was cancelled and exact replacement workflow 31128215642 is waiting; live readback therefore still serves the superseded index-D3Ze7vr7.js bundle. Do not call the release live until that exact run succeeds and the new bundle is read back. Backend tpc-api-lvpc9b1e47e remains unchanged at 100%. After publication, continue bounded official-content approval, pilot-scale concurrency evidence and replacement/unpublication of the sole dummy mock before launch.",
    },
    {
      ...
      next:  "Private origin/main is bb9eba6 after the complete Academy UI/rebranding integration. The source includes the A–F Designer Space attribution/ownership rules, responsive curation gallery and navigation fix, Field Atlas adoption, measured Pico SVG and micro-motion, Academy logo/name replacement, and a world-space 我的星空 scene with approved 4680px WebP atmosphere plus depth-sensitive camera layers. Frontend 843/843, backend 758/758, both audits at 0 and the production build passed. Publication artifact f5145db is ready; replacement GitHub Pages workflow 31128215642 is waiting after the outage-stuck run was cancelled, so live verification remains the sole release blocker. Open product lanes remain official K2/K3 content, pilot reliability and signed-in Report UAT.",
    },
    {
      id:    "entrance-qr-scan",
  ...
  board: {
    now: [
      ...
      { title: "Academy UI release — source complete, live verification pending", project: "tpc-online-platform", owner: "max", note: "Private main bb9eba6 consolidates the full 2026-08-06/07 visual sprint: cool palette with pure-white light surfaces and saturated foregrounds; accent blue replacing signature green; responsive A–F Designer Space with author attribution and correct TPC Buddy/Pico ownership; Field Atlas on the real answer screen; measured, animated Pico; Academy name/lockup across learner/admin/auth surfaces; and a performant world-space 我的星空 observatory using the approved atmosphere asset. Public artifact f5145db is pushed; replacement Pages workflow 31128215642 is waiting after the outage-stuck run was cancelled, and live still serves index-D3Ze7vr7.js. Close this card only after exact-SHA workflow success plus live bundle/asset/browser readback." },
