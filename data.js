...
window.TPC_DASHBOARD = {
  ...
  focus:
    "Pilot readiness is now bottlenecked by approved official K2/K3 content and measured human/device evidence, not the fixed-mock report or fallback foundation. Backend source 5552ba16 is live on tpc-api-fm5552ba16 at 100%; frontend source b38d43aa is live as Pages a50a18cf. WS6.1-13, WS6.1-31a–31f and WS6.3-07/-08 are shipped. Run the real WS6.1-10/11/29 pilot and 10–20-device rehearsal before UAT, replace or unpublish the sole dummy mock, and treat repository enforcement as best-effort until a paid GitHub branch rule blocks direct/manual bypass.",
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "Current live boundary: frontend source b38d43aa is Pages a50a18cf through successful workflow 31168614500, serving index-Dp9Ew9mb.js and index-wWaS5Ztz.css; backend source 5552ba16 is tpc-api-fm5552ba16 at 100%, digest sha256:552224c7e9da6511a70950b27e1c44bb998f6e4075b3b95635837573b71b0d23, with PRACTICE_COMPARISON_ENABLED=true and max-instances=1. PR #204's bilingual global/invalid-question recovery is live and WS6.1-13 is complete. Remaining launch gates are approved official K2/K3 content, real WS6.1-10/11/29 human/device evidence, and replacement/unpublication of the sole dummy mock.",
    },
    {
  ...
  board: {
    now: [
      ...
      { title: "Pilot reliability evidence", project: "tpc-online-platform", owner: "natalie", note: "WS6.1-13/13a–13c are closed and live: the fallback matrix, bilingual global ErrorBoundary and child-safe invalid-question path shipped in PR #204. WS6.1-10/10a–10d, WS6.1-11 and WS6.1-29 still require real controlled concurrency, a small-class pilot, and the 10–20-device one-hour rehearsal. Unit tests or one-device evidence do not close them. Isolate requests by requestId, wait for the closing api_request event, and monitor Sheets reads, retries, quota and errors through the whole window." },
    ...
    next: [
      ...
      { title: "WS6.1 - pilot-gating polish", project: "tpc-online-platform", owner: "natalie", note: "Do only launch-critical work before real users: pilot-scale concurrency/write-contention proof and accuracy consistency -> WS6.1-11. WS6.1-13's fallback audit and WS6.1-15/15a's Mixed · Easy · 10 decision/review are closed; no unavailable learner result is claimed. Broader recommendation review/pilot remain WS8-03a/-03b, while the real small-class launch pilot remains WS6.1-11. WS6.1-28 latest-version exposure/accuracy telemetry is complete and live; the Aug 3 overlap does not close real-device concurrency." },
  ...
  roadmap: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "WS6.1-13/13a–13c - Fallback matrix + bilingual global/invalid-question recovery (PR #204 live)", state: "done" },
