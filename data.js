...
window.TPC_DASHBOARD = {
  ...
  board: {
    now: [
      ...
      { title: "Learner UI design sprint — 答題畫面 first", project: "tpc-online-platform", owner: "max", note: "Local demo has 14 visual design fixtures and ?demo=1&visual=1. Designer Space steps 1–4 are built on feat/answering-ui-revamp (not merged/deployed): preview toggle, 設計 tab with Playground/Atelier, and the adoption round — Max ruled 採用 A 嘅形狀 + B 嘅字級. Harness + fixtures + mascot now carry the tonal model (WS3.1-04d closed); answering screen has B's size scale and A's card radius 26; no palette adopted. Tree dirty for review. Design freeze Aug 21; feeds the WS6.2 review lane." },
