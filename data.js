...
window.TPC_DASHBOARD = {
  ...
  focus:
    "Founder sprint to UAT (Sep 10â13, K2/K3 deep): cook the generation recipe in the offline harness (Dixon-reviewed daily batches â GO/NO-GO Aug 21â23), redesign the learner UI to K2-self-operable (WS6.2, design freeze Aug 21), then fill the pools through the governed lane (WS5.1-04). Main is already stable â 01m merged and WS4.2 production-complete â and Treasure activation remains on hold.",
  ...
  board: {
    now: [
      ...
      { title: "ç¬¬ä¸ç batchï¼harnesså·²èµ·å¥½ï¼", project: "tpc-online-platform", owner: "max", note: "Harness B1âB4 BUILT + smoked 2026-08-03 (branch docs/offline-recipe-harness-spec, PR #70): validator with per-archetype answer recompute, headless gen/judge runners, blind review.html, agreement reports. Real-model smoke passed 3/3. First 12â15q batch fires tonight; Dixon blind-reviews all tomorrow morning â unfiltered verdicts double as threshold calibration. Baseline prompts: qf-gen-visual + qf-judge-visual draft v0. Text lane awaits Natalie's prompts:export (active QF-GEN 23b). Harness output never imports into production (D11)." },
  ...
  roadmap: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Offline recipe harness Â· daily batch loop â GO/NO-GO Aug 21â23 (D11)", state: "active" },
