...
window.TPC_DASHBOARD = {
  ...
  focus:
    "Founder sprint to UAT (Sep 10–13, K2/K3 deep): cook the generation recipe in the offline harness (Dixon-reviewed daily batches → GO/NO-GO Aug 21–23), redesign the learner UI to K2-self-operable (WS6.2, design freeze Aug 21), then fill the pools through the governed lane (WS5.1-04). Main is already stable — 01m merged and WS4.2 production-complete — and Treasure activation remains on hold.",
