...
window.TPC_DASHBOARD = {
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "The 2026-08-07 Academy visual release is LIVE from application source b178936 as public Pages 2ec1bed. Workflow 31155153060 completed successfully and HTTP/live-HTML readback serves index-Dst4Zpam.js plus index-Df0ZpXyZ.css. It includes the platform-wide cool/pure-white/accent-blue language, Academy lockup/name, six credited curations, Field Atlas answer screen, measured Pico, and the finished living-observatory 我的星空: shared-camera depth layers, approved atmosphere plate, Visual Lab, two observatory variants, live telemetry, acquisition HUD, living constellation/unresolved glow, animated guide dashes, and independently controlled background-star blinking. Frontend 856/856 and the 125-module build passed; backend tpc-api-lvpc9b1e47e remains unchanged at 100%. Continue bounded official-content approval, pilot-scale concurrency evidence and replacement/unpublication of the sole dummy mock before launch.",
    },
    {
      ...
      next:  "Private origin/main is 2be9a6c after the complete Academy UI/rebranding and release-documentation integration; application source b178936 is the exact deployed frontend revision. The final source adds the permanent development-only Visual Lab with registry-driven layer controls and JSON/AI-prompt export; shared-camera living-observatory rendering; two technical observatory variants; responsive constellation centring; acquisition HUD; independent completed/unresolved glow; configurable guide dashes; and Glow Stars blink frequency/intensity controls (live defaults 2× / 1.5×). Frontend 856/856, production build, npm audit and encoding gates passed. Public workflow 31155153060 and live bundle readback are green. Open product lanes remain official K2/K3 content, pilot reliability and signed-in Report UAT.",
    },
    {
      id:    "entrance-qr-scan",
