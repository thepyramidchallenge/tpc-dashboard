...
window.TPC_DASHBOARD = {
  ...
  focus:
    "Pilot readiness is now bottlenecked by approved official K2/K3 content and measured human/device evidence, not the fixed-mock, fallback or My Sky mobile foundation. Backend source 5552ba16 is live on tpc-api-fm5552ba16 at 100%; frontend source c80d3139 is live as Pages 6fb90546. WS6.1-13, WS6.1-31a–31f, WS6.2-23 and WS6.3-07/-08 are shipped. Run the real WS6.1-10/11/29 pilot and 10–20-device rehearsal before UAT, replace or unpublish the sole dummy mock, and treat repository enforcement as best-effort until a paid GitHub branch rule blocks direct/manual bypass.",
  ...
  projects: [
    ...
    },
    {
      ...
      owner: "natalie",
      tag:   "The Pyramid Challenge Academy · Learning platform (Phase 1)",
      role:  "The Pyramid Challenge Academy interactive Practice/Test SPA for K2–P6. Backend on Google Sheets behind an adapter (Firestore/Supabase-ready).",
      status: "active",
      health: "active",
      repo:  "github.com/thepyramidchallenge/tpc-online-platform",
      run:   "cd tpc-online-platform/prototype-v0.2 && npm install && npm run dev   # Vite local URL",
      next:  "Current live boundary: frontend source c80d3139 is Pages 6fb90546 through successful workflow 31254816188, serving index-DrdfNqSy.js and index-I_fUQny1.css. PR #220 completes WS6.2-23: one desktop/mobile My Sky standard with adaptive budgets, iPad portrait fit, graded WebKit-safe glow, non-restarting camera drag, retained mobile guide/energy dash motion and Reduced-only animation suppression; Max accepted the real-iPad local preview before deploy. Backend source 5552ba16 is tpc-api-fm5552ba16 at 100%, digest sha256:552224c7e9da6511a70950b27e1c44bb998f6e4075b3b95635837573b71b0d23, with PRACTICE_COMPARISON_ENABLED=true and max-instances=1. Remaining launch gates are approved official K2/K3 content, real WS6.1-10/11/29 human/device evidence, and replacement/unpublication of the sole dummy mock.",
    },
    {
      id:    "tpc-online-platform-admin",
      name:  "tpc-online-platform-admin",
      owner: "natalie",
      tag:   "Academy platform — full private repo",
      role:  "FULL private The Pyramid Challenge Academy project: React v0.2 frontend + Cloud Run backend + docs + sheets templates. The public tpc-online-platform is its published-frontend mirror.",
      status: "active",
      health: "active",
      ...
      next:  "Private main is c80d3139 after the exact-CI evaluator merged PR #220. Backend source 5552ba16 is live on tpc-api-fm5552ba16 at 100%; frontend source c80d3139 is live as Pages 6fb90546 and includes the accepted My Sky mobile/portrait/gesture lane. PRs #180 and #197 leave automated merges exact-head-CI-gated but remove mandatory non-author approval; CODEOWNERS is advisory. Native branch protection is unavailable on the current private-Free plan, so direct pushes/manual merges remain possible. The durable fix remains a paid branch rule requiring pull requests, exact CI jobs, an up-to-date branch and no direct/force-push/delete bypass.",
    },
    {
      id:    "entrance-qr-scan",
  ...
  board: {
    now: [
      ...
      { title: "Pilot reliability evidence", project: "tpc-online-platform", owner: "natalie", note: "WS6.1-13/13a–13c are closed and live: PR #204 shipped the matrix and bilingual recovery UI; PR #209 then separated invalid-question recovery from destructive discard and proves the same draft identity plus an existing answer survive leave/resume. WS6.1-10/10a–10d, WS6.1-11 and WS6.1-29 still require real controlled concurrency, a small-class pilot, and the 10–20-device one-hour rehearsal." },
      { title: "Repository enforcement — best-effort only", project: "tpc-online-platform", owner: "natalie", note: "PR #180 fixed concurrent-merge verification and PR #197 changed automated delivery to exact-head CI without mandatory non-author approval. Native branch protection still returns GitHub plan error 403, so direct pushes and manual merges can bypass the evaluator; PR #197 itself merged after its final head changed without another CI run. Durable fix: upgrade the private repository plan, then require pull requests, exact repository/frontend/backend/factory/gate checks, up-to-date branches, resolved conversations, and block direct/force pushes, deletion and administrator bypass. Until then call this best-effort, never protected." },
    ],
    next: [
      ...
      { title: "WS6.3 report tab enhancements", project: "tpc-online-platform", owner: "dixon", note: "Real rolling Practice evidence, refType=set Mock history/Result drill-in, minimum-data and sync guards are live. PR #184 shipped the approved Mock no-evidence/recovery states; PR #195 removed synthetic Mock rankings and shipped real-only results plus a ready-only broad comparison from the server's ≥10 privacy gate. WS6.3-07/-08 and the WS6.3-06d decision are complete. Remaining functional work is WS6.3-01 accuracy trend and WS6.3-02 topic/domain 7d/30d/all, with the matching WS6.3-05 coverage. A real ready-cohort readback is optional follow-up evidence rather than a release blocker." },
      { title: "WS6.1 - pilot-gating polish", project: "tpc-online-platform", owner: "natalie", note: "Do only launch-critical work before real users: pilot-scale concurrency/write-contention proof and accuracy consistency remain under WS6.1-11. WS6.1-13's fallback audit and WS6.1-15/15a's Mixed · Easy · 10 decision/review are closed; no unavailable learner result is claimed. Broader recommendation review/pilot remain WS8-03a/-03b, while the real small-class launch pilot remains WS6.1-11." },
  ...
  roadmap: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "WS6.1-31a–31f · Fixed-mock report and ≥10 privacy foundation — migrated, deployed, UAT/read budgets complete; PR #195 presentation live", state: "done" },
        { label: "WS6.1-15/15a - Mixed · Easy · 10 cold-start default + targeted responsive review (PR #202 merged; no learner result claimed)", state: "done" },
        { label: "WS6.1-13/13a–13c - Fallback matrix + bilingual recovery + non-destructive draft exit (PRs #204/#209 live)", state: "done" },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "WS6.2-23 · My Sky mobile parity/performance + portrait/gesture/dash fixes (PR #220 / c80d313 / Pages 6fb9054 live)", state: "done" },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "WS6.3-07 · Mock report no-evidence and recovery states — approved, implemented and live through PR #184", state: "done" },
        { label: "WS6.3-08 · Real-only Mock participant report + ready-only ≥10 privacy-safe comparison — PR #195 live", state: "done" },
        { label: "ReportHub ranking boundary · Synthetic Mock rankings removed; real ready-only comparison policy shipped", state: "done" },
      ],
    },
    {
      project: "tpc-online-platform",
  ...
  changelog: [
    { date: "2026-08-08", who: "Max + Codex", project: "tpc-online-platform",
      summary: "MY SKY MOBILE RELEASE — LIVE AND VERIFIED. Max accepted the real-iPad local preview and authorized merge plus deploy. The trusted exact-CI evaluator merged PR #220 as source c80d3139; the clean detached publisher passed 902/902 frontend tests across 49 files, zero npm vulnerabilities, the 128-module build and encoding guard, then published Pages 6fb90546 through successful workflow 31254816188. The live site serves index-DrdfNqSy.js / index-I_fUQny1.css. The release keeps one authored desktop/mobile standard while lowering mobile render budgets, restores the detailed nebula composite with the 2560px derivative, replaces WebKit-sensitive star blur with graded radial emission, fits the acquired star and semantic anchor in portrait fullscreen, prevents camera drag from restarting the newest-star animation, and retains unresolved-guide plus earned-line dash motion on mobile; forced Reduced remains static. HTTP, bundle and served-CSS readback passed. No Cloud Run, OAuth, DNS, Sheets or production-data change." },
    { date: "2026-08-08", who: "Max + Codex", project: "tpc-online-platform",
    ...
    { date: "2026-08-07", who: "Natalie + Codex", project: "tpc-online-platform",
      summary: "CORRECTION — WS6.1-13 REOPENED PENDING PR #209. Independent audit found that PR #204's invalid-question leave action reused the destructive draft-discard path, contradicting the preservation contract. PR #207 was returned to draft before merge. Focused PR #209 separates recovery from discard and has real-App coverage proving draft identity plus an existing answer survive leave/resume without a discard API call. Until that exact source merges and deploys, the live recovery UI is not recorded as fully closed. Human/device gates WS6.1-10/11/29 remain open." },
    { date: "2026-08-07", who: "Natalie + Codex", project: "tpc-online-platform",
      summary: "WS6.1-13 FALLBACK GATE LIVE; HUMAN/DEVICE GATES STAY OPEN. Platform PR #204 merged through exact-head CI as source b38d43aa and is live as Pages a50a18cf through workflow 31168614500. The release adds a bilingual whole-app ErrorBoundary and child-safe missing/unsupported/malformed-question recovery that omits internal identifiers and cannot answer or submit; 877/877 frontend tests, all aggregate gates, HTTP 200 asset readback and served zh-HK/en markers passed. The launch runbook now pins recovery, small-class and 10–20-device evidence. No learner/device result is invented: WS6.1-10/11/29, official K2/K3 content and dummy-mock retirement remain open. No backend, Sheets, cohort, QuestionSet or traffic change." },
    { date: "2026-08-07", who: "Natalie + Codex", project: "tpc-online-platform",
      summary: "WS6.1-15/15a CLOSED WITHOUT INVENTED EVIDENCE. Platform PR #202 merged as main 9e1cbb77 after exact-head CI. The accepted cold-start remains Mixed · Easy · 10; live desktop and 390×844 Practice Setup review confirmed one primary Start action, collapsed optional controls, a separate Mock section and no horizontal overflow, while targeted cold-start/quick-start tests passed 32/32. Natalie confirmed that a separate genuine first-time-learner result will not be available for this configuration-choice item, so none is claimed. Broader recommendation review/pilot remain WS8-03a/-03b, and the real small-class launch pilot remains WS6.1-11. Documentation/dashboard only; no frontend deployment, backend, traffic or Sheets change." },
    { date: "2026-08-07", who: "Codex", project: "tpc-online-platform",
      summary: "DASHBOARD RELEASE-TRUTH REFRESH. Replaced the stale August 4 backend/report lane with the verified August 7 boundary: backend source 5552ba16 on Cloud Run tpc-api-fm5552ba16 at 100% (digest sha256:552224c7e9da6511a70950b27e1c44bb998f6e4075b3b95635837573b71b0d23, comparison enabled, max-instances 1) and frontend source 65a9089e on Pages 5cf82d9 through workflow 31162004352. WS6.1-31a–31f and WS6.3-07/-08 are recorded complete; PR #184's recovery states and PR #195's real-only, ready-only ≥10 privacy presentation are live, and the obsolete read-budget/start-proof blockers are removed. The closed release lane left Blocked; remaining pilot work is explicitly WS6.1-10/11/13/29. Repository governance is now recorded as best-effort rather than protected: PR #180 fixed merge-race verification, PR #197 removed mandatory non-author approval, native protection remains plan-blocked, and the PR #197 transition merged a zero-check final head after the checked head changed. The durable fix is a paid branch rule enforcing PR-only writes, exact required checks, an up-to-date branch, and no direct/force-push/delete/admin bypass. Dashboard-only truth update; no platform code, traffic, Sheets or production data changed." },
    ...
    { date: "2026-08-07", who: "Max + Codex", project: "tpc-online-platform",
      summary: "PUBLIC SKY-ASSET HOTFIX — LIVE AND VERIFIED. Side-by-side local/public review exposed that the approved atmosphere raster and static far-star plate were absent only on GitHub Pages. Root cause was deterministic: Home and CSS used root-absolute /img/home/ URLs, which localhost served successfully but the project site requested from thepyramidchallenge.github.io/img/ and received 404; the real files lived under /tpc-online-platform/img/. Both render layers are now Vite-BASE_URL-aware, including the duplicated chromatic pigment use, and deploy.sh fails closed if a future production bundle contains root-absolute sky paths. Source 7e6a53b deployed as Pages cd4eda9 through successful workflow 31158836059; live HTML serves index-C3AFfMpm.js / index-CstKOGuq.css, and direct atmosphere WebP plus far-star SVG readback both returned HTTP 200. Full gates remained 856/856 tests and a 125-module build. Docs-only main 231379f records the corrected boundary; no backend or data state changed." },
    { date: "2026-08-07", who: "Max + Codex", project: "tpc-online-platform",
    ...
    { date: "2026-08-07", who: "Max + Codex", project: "tpc-online-platform",
      summary: "ACADEMY UI + REBRANDING RELEASE, SOURCE COMPLETE / PUBLICATION WAITING. Max and Codex consolidated the full 2026-08-06/07 visual sprint onto private `tpc-online-platform-admin` main `bb9eba6` (31 commits after the prior `c083eb4` boundary). The platform is formally **The Pyramid Challenge Academy**: the founder-supplied Academy lockup replaces the retired logo/wordmark across sign-in, learner, admin and document-title surfaces. The new product language is cool rather than warm, keeps the lightest surfaces pure white, uses saturated foreground objects and the accent blue instead of signature green. Designer Space now contains responsive A–F curations with attribution (A–C Opus 5, D/F Grok 4.5, E Codex), correct mascot ownership (TPC Buddy on A–D/F; Pico only on E), streamlined top navigation, and Field Atlas adopted on the real answer screen. Pico was redrawn against measured concept geometry—shared rounded apex, luminous cyan facet, positive larger face, contour rings—and now has relative lift, organic body motion, coherent blinking and a moving survey locator. 我的星空 was rebuilt as a living observatory rather than a fixed wallpaper: shared world camera, depth-sensitive atmosphere/distant/mid/guide/constellation layers, approved 4680px WebP atmosphere with overscan, restrained independent twinkles/dust/nebula/meteors, fullscreen mode, quiet central hierarchy and reduced-motion handling. Final gates passed: frontend 843/843 + 123-module build + audit 0; backend 758/758 + lint 0 errors + audit 0; factory/repository/encoding/diff checks green. The source deploy produced public `gh-pages` artifact `f5145db`; outage-stuck workflow `31127881957` was cancelled and exact replacement `31128215642` is waiting, while live readback still returns the superseded `index-D3Ze7vr7.js`. This is therefore **not yet a live-release claim**. Backend traffic was not changed." },
