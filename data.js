...
window.TPC_DASHBOARD = {
  ...
  focus:
    "Pilot readiness is now bottlenecked by approved official K2/K3 content and measured human/device evidence, not the fixed-mock or fallback foundation. Backend source 5552ba16 is live on tpc-api-fm5552ba16 at 100%; frontend source 12e71ccb is live as Pages 47b2412a. WS6.1-13, WS6.1-31a–31f and WS6.3-07/-08 are shipped. Run the real WS6.1-10/11/29 pilot and 10–20-device rehearsal before UAT, replace or unpublish the sole dummy mock, and treat repository enforcement as best-effort until a paid GitHub branch rule blocks direct/manual bypass.",
