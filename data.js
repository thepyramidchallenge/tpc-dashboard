...
window.TPC_DASHBOARD = {
  ...
  meta: {
    updated:   "2026-07-15",
    updatedBy: "founder + Claude (Opus 4.8)",
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "Live = Pages f8d8fcf · Cloud Run tpc-api-00060-wxv. Local source validation = frontend 424 (02f) / backend 151 (01c + WS4.3-22). 02e rails are live with k3_m000001_ai seeded; founder §10.2 smoke is the closure gate. 02f is source-complete but must deploy only from d911413 or later after the remaining full-review P1s are triaged. WS5.2-01a is closed; 01c Run 001 awaits human verification before the official seed-pack lane → WS5.1-04 sets.",
    },
    {
