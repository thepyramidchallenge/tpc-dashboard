...
window.TPC_DASHBOARD = {
  ...
  board: {
    ...
    next: [
      { title: "WS5.2 session-watch + saved-review live smokes", project: "tpc-online-platform", owner: "natalie", note: "The two-tab ledger, generationReview column and matching backend/frontend are live. Revision 00087 now releases the exact active attempt immediately after generator, judge, submit or normal interruption failures; duplicate/stale reports cannot overwrite retries or success, with the 12-minute stale window retained for hard outages. Retry the recovery slot, verify the saved full review and finish watch/revocation. Keep old-runtime rows manual and start no normal production batch yet." },
