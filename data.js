...
window.TPC_DASHBOARD = {
  ...
  focus:
    "Pilot readiness is now bottlenecked by approved official K2/K3 content and measured reliability, not the fixed-mock report foundation. Backend source 5552ba16 is live on tpc-api-fm5552ba16 at 100%; frontend source 65a9089e is live as Pages 5cf82d9. WS6.1-31a–31f and WS6.3-07/-08 are shipped, including the ≥10 privacy contract, read budgets and ready-only real comparison presentation. Run WS6.1-10/11/13/29 before UAT, replace or unpublish the sole dummy mock, and treat repository enforcement as best-effort until a paid GitHub branch rule blocks direct/manual bypass.",
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "Current live boundary: frontend source 65a9089e is Pages 5cf82d9 through successful workflow 31162004352, serving index-DBKmPOSr.js and index-C3MJCvUq.css; backend source 5552ba16 is tpc-api-fm5552ba16 at 100%, digest sha256:552224c7e9da6511a70950b27e1c44bb998f6e4075b3b95635837573b71b0d23, with PRACTICE_COMPARISON_ENABLED=true and max-instances=1. PR #195's real-only Mock report and ready-only privacy-safe comparison are live; WS6.1-31a–31f and WS6.3-07/-08 are complete. Remaining launch gates are approved official K2/K3 content, WS6.1-10/11/13/29 reliability evidence, and replacement/unpublication of the sole dummy mock.",
    },
    {
  ...
  board: {
    now: [
      ...
      { title: "Pilot reliability evidence", project: "tpc-online-platform", owner: "natalie", note: "WS6.1-10/10a–10d, WS6.1-11, WS6.1-13/13a–13c and WS6.1-29 remain open: controlled concurrency/write-contention, fallback matrix and recovery UX, the small-class pilot, and the 10–20-device one-hour rehearsal. The Aug 3 overlap and unit tests are evidence but do not close load. Isolate requests by requestId, wait for the closing api_request event, and monitor Sheets reads, retries, quota and errors through the whole window." },
    ...
    next: [
      ...
      { title: "WS6.1 - pilot-gating polish", project: "tpc-online-platform", owner: "natalie", note: "Do only launch-critical work before real users: pilot-scale concurrency/write-contention proof, fallback audit and accuracy consistency -> WS6.1-11. WS6.1-15/15a's Mixed · Easy · 10 default decision and targeted responsive review are closed; no separate first-time-learner result is claimed. Broader recommendation review/pilot remain WS8-03a/-03b, while the real small-class launch pilot remains WS6.1-11. WS6.1-28 latest-version exposure/accuracy telemetry is complete and live; the Aug 3 transient UAT overlap is useful evidence but does not close the concurrency task." },
