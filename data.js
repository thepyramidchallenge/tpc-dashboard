...
window.TPC_DASHBOARD = {
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "Source of truth for full-stack platform work. Private main 2db34db contains the verified Q+A result readback, superadmin-only generation gate and hardened session-paired watch source. Watch uses discovery-only session auth, quiet in-flight heartbeats, a submission capability bound to one slot/attempt, a two-strike failure breaker and targeted one-slot recovery. Backend 268/268, frontend 475/475 and build pass; GenerationCompanionSessions migration, deploys and non-promoting smoke remain pending.",
    },
    {
      id:    "entrance-qr-scan",
