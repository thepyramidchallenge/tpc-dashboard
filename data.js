...
window.TPC_DASHBOARD = {
  ...
  board: {
    ...
    next: [
      { title: "WS5.2 session-watch + saved-review live smokes", project: "tpc-online-platform", owner: "natalie", note: "The two-tab ledger, generationReview column and matching backend/frontend are live. Revision 00086 fixes the production-only pre-promotion fingerprint rejection while preserving the final approval fingerprint gate. Retry the same genjob_d586… slot 1 as attempt 3, then verify the saved full review and finish watch/revocation. Keep old-runtime rows manual and start no normal production batch yet." },
