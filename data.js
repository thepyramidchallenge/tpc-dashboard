...
window.TPC_DASHBOARD = {
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "Current gate: honestly blinded WS5.2-01c6 calibration → 01c7 go/no-go. The split GenerationJobs/GenerationSlots ledger, Questions.generationReview, complete independent-review display and session-watch UI are live on Cloud Run 00085 / Pages 171a69c without a global write freeze. First new-review submit failed closed; safe validation-stage diagnostics are live. Retry that slot, then complete the non-promoting watch/revocation and saved-review readback smokes. Existing old-runtime rows remain manual.",
    },
    {
  ...
  board: {
    ...
    next: [
      { title: "WS5.2 session-watch + saved-review live smokes", project: "tpc-online-platform", owner: "natalie", note: "The two-tab ledger, generationReview column and matching backend/frontend are live. Retry genjob_d586… slot 1 under diagnostic revision 00085; any rejection now names shape/comparison/evaluation/rationale without logging content. Then finish watch/revocation and saved-review readback. Keep old-runtime rows manual and start no normal production batch yet." },
