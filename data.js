...
window.TPC_DASHBOARD = {
  ...
  projects: [
    ...
    },
    {
      ...
      next:  "Live stack: Pages 6c15afe (minimal source hotfix 1a14da5 based on live bad3490) + Cloud Run tpc-api-00079-lkw (100%, max instances 1). The one-job companion command now uses npm --prefix and works from any folder, including ~. This hotfix deliberately did not activate the pending session-watch UI. Q+A results plus session-paired watch remain source-built only; migrate GenerationCompanionSessions, deploy backend/frontend and run a non-promoting smoke before use.",
    },
    {
